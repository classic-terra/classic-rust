...
pub struct ComputeTaxRequest {
    ...
    pub tx: ::core::option::Option<cosmos_sdk_proto::cosmos::tx::v1beta1::Tx>,
...
pub struct ComputeTaxResponse {
    ...
    pub tax_amount: ::prost::alloc::vec::Vec<cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
}
include!("terra.tx.v1beta1.tonic.rs");
