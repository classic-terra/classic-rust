...
pub struct QuerySwapResponse {
    ...
    #[prost(message, optional, tag = "1")]
    pub return_coin: ::core::option::Option<cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
}
...
pub struct MsgSwap {
    ...
    pub offer_coin: ::core::option::Option<cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
    #[prost(string, tag = "3")]
    pub ask_denom: ::prost::alloc::string::String,
}
...
pub struct MsgSwapResponse {
    #[prost(message, optional, tag = "1")]
    pub swap_coin: ::core::option::Option<cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
    #[prost(message, optional, tag = "2")]
    pub swap_fee: ::core::option::Option<cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
}
...
include!("terra.market.v1beta1.tonic.rs");
