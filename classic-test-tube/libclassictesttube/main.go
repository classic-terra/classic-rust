...
import (
	...
	// cosmwasm-testing
	"github.com/classic-terra/test-tube/classic-test-tube/result"
...
func InitTestEnv() uint64 {
	...
	sdkConfig.SetCoinType(coretypes.CoinType)
	sdkConfig.SetPurpose(coretypes.Purpose)
	sdkConfig.SetBech32PrefixForAccount(coretypes.Bech32PrefixAccAddr, coretypes.Bech32PrefixAccPub)
