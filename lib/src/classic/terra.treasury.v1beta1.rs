...
pub struct PolicyConstraints {
    ...
    pub cap: ::core::option::Option<cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
    #[prost(string, tag = "4")]
...
pub struct EpochTaxProceeds {
    ...
    pub tax_proceeds: ::prost::alloc::vec::Vec<cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
}
...
pub struct EpochInitialIssuance {
    #[prost(message, repeated, tag = "1")]
    pub issuance: ::prost::alloc::vec::Vec<cosmos_sdk_proto::cosmos::base::v1beta1::Coin>,
}
...
include!("terra.treasury.v1beta1.tonic.rs");
